...
ROOT_URLCONF = "wagtail_readonly_task.test.urls"
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_wagtail_readonly_task.db"),
}
...
WAGTAIL_SITE_NAME = "Wagtail Read-only Workflow Task test site"
